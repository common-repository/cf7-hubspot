...
Send Contact Form 7, WPForms, Elementor, Ninja Forms, WPforms, Elementor, Ninja Forms, Contact Form Entries Plugin and many other contact form submissions to hubspot.
...
Easily integrate contact form 7 to HubSpot with free Wordpress Contact Form 7 HubSpot Plugin. Connect HubSpot account and map already existing contact form fields to any HubSpot object fields.
...
* You can manually send any Ninja Forms entry to hubspot by clicking "send to hubspot" button.
...
= 1.3.1 =
* fixed "company name" field in hubspot online form.
* fixed "wpml domain name" issue.
